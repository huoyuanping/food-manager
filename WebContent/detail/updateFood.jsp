            ...
            <div class="ItemBlock">
				<div class="ItemBlock2">
                    ...
                    <tr>
							<td width="80px">菜系</td>
							<td>
							<jsp:useBean id="temp" class="com.et.model.foodtype.MyFoodType"></jsp:useBean>
                            <select name="typeId" style="width:80px">
	            
			   					  <c:forEach var="tmp" items="${temp.foodType}">
									
			   						<option value="${tmp.TYPEID}" 
			   						<c:if test="${tmp.TYPEID==param.typeId}">
			   							selected="selected"
			   						</c:if>>${tmp.TYPENAME}</option>
			   					</c:forEach>
                            </select>
						...
						<tr>
							<td>简介</td>
							<td><textarea name="introduce" class="TextareaStyle">${param.desc}</textarea></td>
						</tr>
						<tr>
							...
							<td>
									...
									src="${pageContext.request.contextPath}/ImageServlet?imageName=${param.imgPath}">
