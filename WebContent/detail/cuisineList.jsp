...
function deleteFoodType(tId){
	if(confirm("是否删除当前数据")){
		window.location="DeleteFoodTypeServlet?typeId="+tId;
	}
}
</script>
</head>
<body>
	...
	<div id="MainArea">
		<table class="MainArea_Content" align="center" cellspacing="0" cellpadding="0">
			...
			<!--显示数据列表 -->
			<tbody id="TableData">
				<c:forEach var="tmp" items="${requestScope.foodtypelist.data }">
					<tr align="center">
						...
						<td>
							...
							<a href="javascript:deleteFoodType(${pageScope.tmp.TYPEID})"  class="FunctionButton">删除</a>
						</td>
					</tr>
				</c:forEach>
